...
const AddTask = ({ data, method, allMembers }) => {
  ...
  const handleSubmit = async (e) => {
    e?.preventDefault();
    if(newTask?.members?.length ===0 ) return alert("Members Are Required")
  ...
  return (
    ...
    >
      ...
      <div
        className="w-full p-[20px] flex gap-[20px] justify-evenly ml-[20px] flex-wrap bg-white shadow-2xl rounded-2xl"
        ...
        >
          ...
          <input
            ...
            onChange={(e) => {
              ...
              const oldFile = [...newTask?.files];
              for (const itemsWithin of files) {
                oldFile.push(itemsWithin);
              }
              setNewTask((prev) => ({ ...prev, files: oldFile }));
            }}
          />
          <br />
          <br />
