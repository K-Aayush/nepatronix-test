...
const BlogCard = ({ data }: { data: any }) => {
  ...
  return (
    ...
    >
      <motion.div
        className="absolute w-full h-full p-4 overflow-hidden text-center shadow-lg rounded-2xl bg-white/10"
          ...
          <div>
            ...
            <div className="flex text-lg text-gray-700 justify-evenly">
              <span className="flex items-center">
                <FaEye className="mr-1" /> {formatNumber(data?.views)}
              </span>
              <span className="flex items-center">
              ...
              <span className="flex items-center">
                <FaThumbsUp className="mr-1" /> {formatNumber(data?.likes)}
              </span>
            </div>
            <div
              className="hidden"
